...
class DebugDirectives
{
     ...
     * @return mixed
     */
    public function breakpointDirective($value, $pattern, $replacement, Application $app, Compiler $blade)
    {
     ...
     * @return mixed
     */
    public function debugDirective($value, $pattern, $replacement, Application $app, Compiler $blade)
    {
        return preg_replace($pattern, $replacement, $value);
    }
}
